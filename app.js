var app = angular.module("myApp", ["ngRoute","ControllerModule","FactoryModule"]);
...
app.service('scrollAndResizeListener', function($window, $document, $timeout) {
    var id = 0,
        listeners = {},
        scrollTimeoutId,
        resizeTimeoutId;
...
app.directive('imageLazySrc', function ($document, scrollAndResizeListener) {
        return {
            restrict: 'A',
            ...
            var listenerRemover;
                ...
                // get element position
                    ...
                    if ((imageRect.top >= 0 && imageRect.bottom <= clientHeight) && (imageRect.left >= 0 && imageRect.right <= clientWidth)) {
